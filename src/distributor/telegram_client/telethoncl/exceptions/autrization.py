...
class UserNotAuthorizedError(AuthorizationError):
    ...
    def __init__(self, message=None):
        super().__init__(f"Client not authorized{message} ")
...
class ClientAuthorizationConnectionError(AuthorizationError):
    ...
    def __init__(self, message=None):
        super().__init__(f"Client can't Authorize {message} ")
...
class MaxAttemptsExceededError(AuthorizationError):
    ...
    def __init__(self, message=None):
        super().__init__(f"Max auth try {message} ")
...
class AutorizationFaildError(AuthorizationError):
    ...
    def __init__(self, message=None):
        super().__init__(f"Auth faild {message} ")
