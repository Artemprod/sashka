...
@events.register(events.NewMessage(incoming=True, func=TextFilter(source_type=SourceType.GROUP)))
async def handle_text_message_group(event):
    logger.info(f"New message from GROUP")
