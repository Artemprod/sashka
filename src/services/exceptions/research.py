...
class UserInProgressError(ResearchCompletionError):pass
class ResearchStatusInProgressError(ResearchCompletionError):pass
class UserAndResearchInProgressError(ResearchCompletionError):pass
