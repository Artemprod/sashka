...
from . cases import TestDataCases, PING_TEST_CASES
from src.services.research.telegram.inspector import UserPingator


@pytest.mark.parametrize(
    "test_case",
    [pytest.param(test_case, id=test_case._id) for test_case in PING_TEST_CASES],
)
async def test_unresponde_messages(load_pingator, test_case: TestDataCases):
    ...
    count = await pingator.count_unresponded_assistant_message(
